  ...
  return (
    <div style={{ width: 397, height: 464 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        <div>
          <PostTitle style={{ display: 'flex', marginTop: 8, fontSize: 20, width: 397, height: 78, marginBottom: 0 }}>
            {post.title}
          </PostTitle>
        </div>
        <div style={{ display: 'flex', flexDirection: 'row', height: 57 }}>
          <div style={{ display: 'flex', flexDirection: 'column', width: 280, height: 57, flex: 3 }}>
            <div style={{ display: 'flex', flexDirection: 'row' }}>
              <PostDate style={{ margin: 5, marginLeft: 1, marginRight: 11 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <PostAuthorName onClick={() => history.push(`/@${post.author_name}`)} style={{ margin: 2, marginTop: 5 }}>
                {post.author_name}
              </PostAuthorName>
            </div>
          </div>
          ...
          >
            ...
            <PostLikes style={{ width: 41, height: 36, margin: 0, marginLeft: 4 }}>
