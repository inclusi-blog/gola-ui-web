...
import {
    ...
    ProfileContentHeading, DataField
    ...
    return (
        <ProfileContentContainer>
            ...
            <CenterAlign style={{justifyContent:'space-between'}}>
                <DataField style={{padding:'20px 0px 28px 0px',color:'#606060'}}>Paste your twitter profile link here..</DataField>
                <TwitterIcon src={TwitterImg} style={{width: '32px', height: '32px', marginLeft: '204px'}}/>
            </CenterAlign>
            <CenterAlign style={{justifyContent:'space-between'}}>
                <DataField style={{padding:'28px 0px 28px 0px',color:'#606060'}}>Paste your Facebook profile link here..</DataField>
                <FacebookIcon src={FacebookImg} style={{width: '32px', height: '32px', marginLeft: '204px'}}/>
            </CenterAlign>
            <CenterAlign style={{justifyContent:'space-between'}}>
                <DataField style={{padding:'28px 0px 28px 0px',color:'#606060'}}>Paste your Linkedin profile link here..</DataField>
