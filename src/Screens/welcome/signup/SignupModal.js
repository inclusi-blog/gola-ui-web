            ...
            <If condition={modalName === 'signup' || modalName === 'signin'}>
              <If condition={isSignup}>
                <PromptTextContainer>
                  ...
                  <SigninButton onClick={() => setModalName('signin')}>Sign in</SigninButton>
                </PromptTextContainer>
                ...
                <PromptTextContainer>
                  ...
                  <SigninButton onClick={() => setModalName('signup')}>Sign up</SigninButton>
                  <ForgetPasswordButton onClick={() => setModalName('forgetPassword')}>
                    Forgot password ?
                  </ForgetPasswordButton>
                </PromptTextContainer>
              </If>
