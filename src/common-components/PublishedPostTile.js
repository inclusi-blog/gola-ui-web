...
const PublishedPostTile = ({ details, borderWidth }) => {
  const { id, interests, likes_count, preview_image, published_at, tagline, title, username, url } = details;
