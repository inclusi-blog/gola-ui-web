...
const ForgetPassword = ({ onSuccessForgetPassword }) => {
  ...
  return (
    <ForgetPasswordContainer>
      <HappensText>Don’t worry, happens to the best of us.</HappensText>
      <InformationText>If you have an account with us, We’ll send a password reset link to the mail.</InformationText>
      <FPCenterWrapper>
      ...
      <FPBottomWrapper>
        ...
        <FPContinueButton disabled={!isValidEmail} loading={isLoading} onClick={onSubmit}>
          Continue
        </FPContinueButton>
      </FPBottomWrapper>
    </ForgetPasswordContainer>
